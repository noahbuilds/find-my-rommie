      ...
      <section className="">
        ...
        <div className=" d-flex justify-content-center mt-3">
          <div>
            ...
            {processingUpload ? (
              <p className="text-center">Procesing...</p>
            ) : null}
          </div>
        ...
        <section className="text-center my-2 lead" id="about">
          <p> Update your RoommateFinder profile or delete your account.</p>
        </section>
        {/* <hr className="w-100"></hr> */}
        <div className="m-5">
          <form id="profileForm" onSubmit={handleSubmit}>
            <p className="h4 text-center mt-4 mb-1">Match Listing</p>
                ...
                <div className="form-check-inline">
                  <label className="form-check-label">
                    <input
                      ...
                      name="socialStats"
                      value="extrovert"
                      checked={userProfile?.result.socialStats === "extrovert"}
                      onChange={handleChange}
                    />
                    Extrovert
                  </label>
                ...
                <div className="form-check-inline">
                  <label className="form-check-label">
                    <input
                      ...
                      name="socialStats"
                      value="ambivert"
                      checked={userProfile?.result.socialStats === "ambivert"}
                      onChange={handleChange}
                    />
                    Ambivert
                  </label>
                ...
                <div className="form-check-inline">
                  <label className="form-check-label">
                    <input
                      ...
                      name="socialStats"
                      value="introvert"
                      checked={userProfile?.result.socialStats === "introvert"}
                      onChange={handleChange}
                    />
                    Introvert
                  </label>
            ...
            <label className="row custom-form-row">
              <span className="col-md-12 col-lg-6 col-sm-12 mb-1 py-2 text-center">
                <p className="m-0 p-0">What is your intended major?</p>
              </span>
              <select
                className="col mx-4 mx-sm-0 form-control"
                name="course"
            ...
            <p className="h4 text-center mt-4 mb-1">Housing Preferences</p>
            <label className="row custom-form-row">
              <span className="col-md-12 col-lg-6 col-sm-12 mb-1 py-2 text-center">
            ...
            <label className="row custom-form-row">
              ...
              >
                ...
                <option value="Cold">Cold (Less than 17 °C/63 °F) </option>
                <option value="Cool">Cool (17-20 °C/63-68 °F)</option>
                <option value="Neutral">Neutral (20-23 °C/68-73 °F)</option>
                <option value="Warm">Warm (23-26 °C/73-78 °F)</option>
                <option value="Hot">Hot (More than 26 °C/78 °F)</option>
              </select>
            </label>
            ...
            <label className="row custom-form-row">
              <span className="col-md-12 col-lg-6 col-sm-12 mb-1 py-2 text-center">
                Are you okay with living in a Gender Inclusive room?
                <p className="text-info small m-0 p-0">
                ...
                <div className="form-check-inline">
                  <label className="form-check-label">
                    <input
                      ...
                      value="true"
                      checked={userProfile?.result.genderinclusion === "true"}
                      onChange={handleChange}
                    />
                    Yes
                  </label>
                ...
                <div className="form-check-inline">
                  <label className="form-check-label">
                    <input
                      ...
                      name="genderinclusion"
                      value="false"
                      checked={userProfile?.result.genderinclusion === "false"}
                      onChange={handleChange}
                    />
                    No
                  </label>
            ...
            <label className="row custom-form-row">
              <span className="col-md-12 col-lg-6 col-sm-12 mb-1 py-2 text-center">
                <p className="m-0 p-0">How often can you tolerate visitors?</p>
              </span>
              <select
                className="col mx-4 mx-sm-0 form-control"
              ...
              >
                ...
                <option value="occasionally">Occasionally is okay</option>
                <option value="frequent">All the time is fine with me!</option>
              </select>
            </label>
            ...
            <label className="row custom-form-row">
              ...
              >
                ...
                <option value="MTrackAndField">Men's Track and Field</option>
                ...
                <option value="WTrackAndField">Women's Track and Field</option>
            ...
            <label className="row custom-form-row">
              <span className="col-md-12 col-lg-6 mb-1 py-2 text-center ">
                ...
                <p className="text-info text-center small m-0 p-0">
                  To select multiple options, hold down the Ctrl key on Windows
              ...
              >
                ...
                {activities.map((activity) => (
                  <option
                    key={activity}
                    value={activity}
                    selected={userProfile.result.interests?.includes(activity)}
                  >
                    {activity}
                  </option>
                ))}
            ...
            >
              {processingUpdate ? "Processing" : "Update Profile!"}
            </button>
