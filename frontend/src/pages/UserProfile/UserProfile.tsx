            ...
            <form id="profileForm" onSubmit={handleSubmit}>
                  ...
                  <div className="form-check-inline">
                    <label className="form-check-label">
                      <input
                        ...
                        value="extrovert"
                        checked={
                          userProfile?.result.socialStats === "extrovert"
                        }
                        onChange={handleChange}
                      />
                      Extrovert
                  ...
                  <div className="form-check-inline">
                    <label className="form-check-label">
                      <input
                        ...
                        value="introvert"
                        checked={
                          userProfile?.result.socialStats === "introvert"
                        }
                        onChange={handleChange}
                      />
                      Introvert
                  ...
                  <div className="form-check-inline">
                    <label className="form-check-label">
                      <input
                        ...
                        value="false"
                        checked={
                          userProfile?.result.genderinclusion === "false"
                        }
                        onChange={handleChange}
                      />
                      No
              ...
              <label className="row custom-form-row">
                <span className="col-md-12 col-lg-6 mb-1 py-2 text-center ">
                  ...
                  <p className="text-info text-center small m-0 p-0">
                    To select multiple options, hold down the Ctrl key on
              ...
              <div className="d-flex gap-5 justify-content-center">
                ...
                >
                  {processingUpdate ? "Processing" : "Delete Profile!"}
                </button>
                <button
